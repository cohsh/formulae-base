    ...
    const formulae_set = [
        {
            ...
            formulae: [
                ...
                { description: "Definition", formula: '\\Gamma(z) := \\lim_{n\\to \\infty} \\frac{n^{z}n!}{\\prod_{j=0}^n(z+j)}' },
        ...
        },
        {
            title: "Beta Function",
            formulae: [
                { description: "Definition", formula: '\\mathrm{B}(z_1, z_2) := \\int_0^1 dt t^{z_1-1}(1-t)^{z_2-1},~\\mathrm{Re}(z_1),\\mathrm{Re}(z_2)>0' },
                { description: "Definition", formula: '\\mathrm{B}(z_1, z_2) := 2\\int_0^{\\frac{\\pi}{2}} d\\theta \\sin^{2z_1-1}\\theta \\cos^{2z_2-1} \\theta,~\\mathrm{Re}(z_1),\\mathrm{Re}(z_2)>0' },
        ...
        },
        {
            ...
            formulae: [
                { description: "Definition", formula: '\\mathrm{erf}(z) := \\frac{2}{\\pi^{\\frac12}} \\int_0^z dt e^{-t^2}' },
